...
- [zueai/create-mcp](https://github.com/zueai/create-mcp) - CLI tool that deploys an MCP Server optimized for Cursor to Cloudflare Workers in seconds. Just write TypeScript functions to make MCP tools.
